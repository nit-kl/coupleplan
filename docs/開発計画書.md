...
|------|------|
| 最終更新日 | 2026-05-02 |
| 直近更新（同日） | P1-4 / P1-5 完了。ADR 0012・0013 と `0004_ninja.sql` を追加し、ニンジャ API・週次 publish ジョブ・Web・スモークを実装。 |
...
- **Phase 1** — カップル・デートルーレット・ニンジャの **E2E 可能な範囲**まで
...
| P2-3 | 計測（MVP 指標 §6.3）のイベント設計 | 未着手 |  |  |  |
| P2-4 | 障害/負荷の一次対応 | 未着手 |  |  |  |
