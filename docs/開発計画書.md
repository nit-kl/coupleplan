...
|------|------|
| 最終更新日 | 2026-05-02 |
| 直近更新（同日） | P1-2 / P1-3 完了。ADR 0011 と `0003_roulette.sql` を追加し、デートルーレット API/UI/スモークを実装。 |
...
| T3 | DB | 完了 | Cloudflare D1（[0005](./adr/0005-database-d1.md)）。SQL は `apps/api/migrations/0001_initial.sql` / `0002_refresh_sessions.sql` / `0003_roulette.sql` |
